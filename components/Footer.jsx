...
const Footer = () => {
  ...
  return (
    <footer className='bg-blue-600 py-16 mt-24'>
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 px-4'>
        ...
        {/* Quick Links */}
        <div className='ms-24'>
          <h4 className='text-amber-400 font-bold text-lg mb-3'>Quick Links</h4>
        ...
        <div>
          ...
          <p className='text-white text-sm'>
            ...
            the latest updates, exclusive offers, and more. We are here to
            answer any questions you may have and to assist you in your property
            search.
          </p>
      ...
      <div className='border-t-2 border-amber-500 mt-12 pt-6'>
        <div className='container mx-auto flex flex-col md:flex-row items-center justify-between'>
          ...
          <ul className='flex space-x-6 text-sm mt-4 md:mt-0'>
            <li>
              <Link href='/sitemap' className='text-amber-400 hover:underline'>
                Sitemap
              </Link>
            </li>
            <li>
