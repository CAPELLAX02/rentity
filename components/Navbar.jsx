          ...
          <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
            ...
            <div className='hidden md:ml-6 md:block'>
              <div className='flex space-x-2'>
                <a
                  href='/index.html'
                  className='hover:text-white hover:bg-amber-950 bg-white  text-amber-950 duration-200 rounded-md px-3 py-2 font-medium'
                >
                  Home
                </a>
                <a
                  href='/properties.html'
                  className='text-white hover:text-white hover:bg-amber-950 duration-200 rounded-md px-3 py-2 font-medium'
                >
                  Properties
                </a>
                <a
